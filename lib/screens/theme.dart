        ...
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: buildItems(
                  Icons.color_lens_outlined, "Theme", "Light", false),
            ),
            buildItems(
                Icons.color_lens_outlined, "Default chat theme", "", false),
            Divider(
              height: 0.0,
              color: Variables.lightGrey.withOpacity(0.1),
            ),
            ...
            buildItems(null, "Media visbility",
                "Show newly downloaded media in your device's gallery", true),
            ...
            buildItems(Icons.cloud_upload_outlined, "Chat backup", "", false),
            buildItems(
                Icons.send_to_mobile_outlined, "Transfer chats", "", false),
